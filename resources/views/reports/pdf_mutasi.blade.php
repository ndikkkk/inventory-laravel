...
<body>
    <div class="header">
        ...
        <h3 style="margin:0">BADAN KEPEGAWAIAN DAN PENGEMBANGAN SUMBER DAYA MANUSIA</h3>
        ...
        {{--<p style="font-size: 7pt; margin: 0;">Laporan digenerate otomatis oleh Sistem Informasi dan Manajemen Logistik (SIM-LOG)</p>--}}
    </div>
    ...
    <table class="signature">
        <tr>
            <td width="40%">Mengetahui,<br>Kepala BKPSDM Boyolali<br><br><br><br><br><span style="text-decoration: underline; font-weight: bold;">WASKITHO RAHARDJO, S.H., M.M.</span><br>
                    Pembina Utama Muda<br>
                    NIP. 196907031999031006</td>
            <td width="20%"></td>
            <td width="40%">Boyolali, {{ date('d F Y') }}<br>Pengurus Barang<br><br><br><br><br><span style="text-decoration: underline; font-weight: bold;">{{ Auth::user()->name }}</span></b><br>NIP. {{ Auth::user()->nip ?? '...........................' }}</td>
        </tr>
    </table>
</body>
</html>
