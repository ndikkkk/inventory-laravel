...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            {{-- MODE 1: FITUR BARU (Laporan Lengkap / Beranak-pinak) --}}
                            ...
                            @foreach($items as $row)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center mutasi">
                                        @if(isset($stokAkhir)) {{ $stokAwal }} + {{ $jumlahMasuk }} = <b>{{ $stokAkhir }}</b> @else - @endif
                                    </td>
            ...
            {{-- MODE 2: FITUR LAMA (Export Biasa / Flat) --}}
            @else
                @php
